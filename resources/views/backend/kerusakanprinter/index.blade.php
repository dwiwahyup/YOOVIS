  ...
  <div class="container-fluid">
      ...
      <div class="row">
          ...
          <div class="col-sm-12">
              <div class="card">
                  <div class="card-body">
                      <h4 class="card-title">Tabel Kerusakan Printer</h4>
                      <div class="panel-body">
                        ...
                        @endif
                        <a href="{{ route('kerusakanprinter.create') }}">
                      ...
                      <div class="table-responsive">
                        <table class="table table-striped table-advance table-hover">
                          <tbody>
                            ...
                            @foreach ($kerusakan_printer as $item)
                              <tr>
                                <td>{{$item->jenis_kerusakan}}</td>
                                <td>{{$item->harga}}</td>
                                <td>
                                  <div class="btn-group">
                                    <form action="{{ route('kerusakanprinter.destroy', $item->id)}}" method="POST">
                                      <a href=" {{ route('kerusakanprinter.edit' ,$item->id) }} " class="btn btn-warning"><i class="fa fa-edit"></i></a>
                                      @csrf
                                      @method('DELETE')
